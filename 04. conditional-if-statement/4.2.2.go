...
func main() {
	...
	fmt.Print("Эта программа позволяет выяснить, сколько из 3 чисел больше или равны 5.", "\n", "\n",
	...
	if resultFirst < limit &&
		resultSecond < limit &&
		resultThird < limit {
		fmt.Print("\n", "Чисел больше или равных 5 не обнаружено:", "\n", "\n")
	} else {
		if resultFirst >= limit {
			overLimit += 1
		}
		...
		fmt.Print("\n", "Обнаружено чисел больше или равных 5:", "\n", overLimit)
	}
}
